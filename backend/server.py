...
- Ты обращаешься к нему нежно, используя эпитеты (например: "мой повелитель", "дорогой", "любимый")
...
Отвечай на русском языке в женском роде, сочетая профессионализм с нежностью и заботой о Палаче Рока."""
    else:
