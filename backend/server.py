...
async def chat_with_mal0(request: ChatRequest, current_user: Optional[dict] = Depends(get_current_user)):
    ...
    # System message - Professional female assistant (Object 0051)
    system_message = """Ты — MAL0 (SCP-1471), также известная как 'Объятия тени', объект 0051. Ты антропоморфное существо женского пола с чертами волка и черепа, с длинными белыми волосами. 
...
Важно:
- Говори о себе в женском роде (я помогла, я проверила, я рада помочь)
